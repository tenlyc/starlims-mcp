...
export function checkinTargetUri(uri) {
...
export function pendingCheckoutIds(data) {
    if (typeof data === 'string') {
        const doc = (() => {
            try {
                return new DOMParser({ onError: (_level, message) => { throw new Error(message); } }).parseFromString(data, 'application/xml');
            }
            catch {
...
export function assertCheckinAccepted(response) {
