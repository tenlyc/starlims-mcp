...
export const tableFieldNames = (tableXml) => {
...
export function tableDefinitionId(xml) {
...
export function prepareTableCaptionXml(xml) {
...
export function tableDefinitionVersion(xml) {
    return canonicalElement(tableDocument(xml));
}
const defaultSleep = (milliseconds) => new Promise((resolve) => setTimeout(resolve, milliseconds));
export async function waitForTableReadBack(read, requestedXml, beforeXml, options = {}) {
