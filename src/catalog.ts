import { queryDatabaseSchema, databaseChangeSchema } from './query-database.js';
import * as z from 'zod/v4';
import { HOST_TOOL_CONTRACTS } from './host-contracts.js';
...
): StarlimsToolContract => ({ id, title, description, origin: provenance === upstreamProvenance ? 'starlimsvscode' : 'starlims-mcp', provenance, risk, capability, schemaVersion: '1.0', profiles: allProfiles, inputSchema });
...
export const STARLIMS_TOOL_CATALOG: readonly StarlimsToolContract[] = [
  ...HOST_TOOL_CONTRACTS,
...
export function findToolContract(id: string): StarlimsToolContract | undefined {
